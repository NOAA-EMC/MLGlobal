...
such as the Global Forecast System (GFS) and Global Ensemble Forecast System (GEFS)
as part of the Experimental AI Global and Limited-area Ensemble (EAGLE) project.
