...
""" Download ERA5 from GCS and save to netCDF file.
    One year per file. 
"""
...
def main():
    ...
    for year in range(start_year, end_year+1):
        ...
        #1deg
        out_1deg = f"./era5_subset_1deg/era5_1deg_6h_{year}.nc"
        dsy_1deg = dsy.isel(latitude=slice(None, None, 4)).isel(longitude=slice(None, None, 4))
        dsy_1deg.to_netcdf(out_1deg)
